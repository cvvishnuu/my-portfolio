...
export const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const notificationTemplateId = "template_d7lv5a8"; // Template to send you the message
    const autoReplyTemplateId = "template_kyibkld"; // Template for auto-reply to sender
    const publicKey = import.meta.env.VITE_EMAILJS_PUBLIC_KEY;

    // Debug logging
    console.log("EmailJS Configuration:", {
      serviceId: serviceId ? "✓ Loaded" : "✗ Missing",
      notificationTemplateId: "✓ template_d7lv5a8",
      autoReplyTemplateId: "✓ template_kyibkld",
  ...
  return (
    <section
      id="contact"
      ref={ref}
      className="relative py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-white via-blue-50/30 to-purple-50/30 dark:from-gray-800 dark:via-blue-950/20 dark:to-purple-950/20 overflow-hidden"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          >
            <h3 className="text-2xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Contact Information
            </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        className="w-full min-h-[150px] border-2 focus:border-primary transition-colors"
                      />
                    </div>
                    ...
                    {submitStatus === "success" && (
                      <motion.div
                        ...
                        className="p-4 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200 rounded-md text-sm font-medium border border-green-200 dark:border-green-800"
                      >
                    ...
                    {submitStatus === "error" && (
                      <motion.div
                        initial={{ opacity: 0, y: -10 }}
                        animate={{ opacity: 1, y: 0 }}
                        className="p-4 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-200 rounded-md text-sm font-medium border border-red-200 dark:border-red-800"
                      >
